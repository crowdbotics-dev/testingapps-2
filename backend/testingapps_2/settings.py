"""
Django settings for testingapps_2 project.
...
ROOT_URLCONF = 'testingapps_2.urls'
...
WSGI_APPLICATION = 'testingapps_2.wsgi.application'
...
DEFAULT_FROM_EMAIL = env.str(
    "DEFAULT_FROM_EMAIL", "testingapps Support <support@testingapps-2.botics.io>"
)
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "testingapps_2 API",
    "DESCRIPTION": "API documentation for testingapps_2 App",
    "VERSION": "v1",
}
